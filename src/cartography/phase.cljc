(ns cartography.phase
  "The verdict -> phase mapping for the ISCO-08 2165 cartography actor, and
  ...
  proposal is written, held, or sent to a human had no test of its own and no
...
(defn refusal?
  ...
  act without a human, not an approval-in-waiting. `cartography.sim` counts
...
(defn approved-commit?
  ...
  measured on the pre-change tree, it could not."
  [disposition]
